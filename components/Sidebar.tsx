    ...
    >
      ...
      <nav className="flex-1 px-3 py-4 space-y-0.5 overflow-y-auto">
        ...
        {navItems.map((item) => (
          ...
          >
            <span className={`flex-shrink-0 ${isActive(item.href) ? "text-white" : "text-gray-400 group-hover:text-gray-600"}`}>
              {item.icon}
            </span>
